  ...
  const educationData = [
    {
      ...
      institution: "IPS Academy Institute of Engineering and Science",
    ...
    {
      id: 2,
      degree: "Higher Secondary Certificate (XII ISC)",
      institution: "Mahatma Gandhi High Secondary School",
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <p className="mt-6 text-gray-300 max-w-2xl mx-auto">
            My academic journey has equipped me with a strong foundation in data science and software development.
          </p>
        </motion.div>
