  ...
  const projects = [
    {
      ...
      description: "Developed an early detection tool for lung cancer by leveraging logistic regression and other ML algorithms. This project includes an interactive interface where users can input basic health information to receive an informed prediction based on their data.",
      icon: <FaHospital />,
      technologies: [
      ...
      highlights: [
        "Implemented logistic regression algorithm for prediction",
        "Created interactive user interface for data input",
        "Achieved high accuracy in early detection predictions",
        "Processed and analyzed large healthcare datasets"
      ],
      links: [
    ...
    },
    {
      ...
      description: "Created a comprehensive management system to streamline student data, course management, faculty coordination, and administrative workflows for an educational institution. The backend was developed in Java, complemented by a frontend built using HTML, CSS, and JavaScript.",
      icon: <FaHospital />,
      technologies: [
      ...
      highlights: [
        ...
        "Created intuitive interfaces for different user roles",
        "Developed automated reporting and analytics features"
      ],
      links: [
        { type: "github", url: "#", icon: <FaGithub /> },
        { type: "live", url: "#", icon: <FaExternalLinkAlt /> }
